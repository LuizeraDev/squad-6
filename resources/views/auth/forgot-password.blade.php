    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="wrapperNomeFPW">
                ...
                <label class=" labelNome" for="email" value="{{ __('Email') }}"><span class="contentNome">Digite seu email</span></>
            </div>
            ...
            <button class="enterButtonReg transform motion-reduce:transform-none hover:-translate-y-1 hover:scale-110 transition ease-in-out duration-300
                ml-4 items-center px-4 py-2 border border-transparent font-semibold text-xs text-white uppercase tracking-widest">
                    {{ __('Recuperar Senha') }}
            </button>
