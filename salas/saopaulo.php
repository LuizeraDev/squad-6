    ...
    <?php 
        if ($quantidade != null) {
            for ($i = 0; $i < $quantidade; $i++) {
                ...
                echo "<br><a href='fila.php?id=". $dados[$i]['cd_sala_sao_paulo'] ."'>Selecionar sala</a><br><br>";
                ...
                <script>
                    ...
                    function excluir ()  
                    {
                        ...
                        if (valor_digitado  == aleatorio) {
                            window.location.href='../funcionalidades/excluir-sala.php?id=". $dados[$i]['cd_sala_sao_paulo'] ."';
                        } else {
